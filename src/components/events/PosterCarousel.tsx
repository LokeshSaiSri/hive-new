...
type Props = {
  ...
  controls?: boolean;
  /**
   * fill — image fills a sized parent (needs aspect ratio / absolute inset wrapper).
   * natural — one image keeps its real ratio on mobile + laptop (no crop).
   */
  layout?: "fill" | "natural";
  /** Only used when layout="fill". contain shows full poster; cover crops. */
              ...
              <Image
                ...
                className={
                  active
                    ...
                    : "pointer-events-none absolute inset-0 z-0 h-full w-full object-contain"
                }
                style={{
                  opacity: active ? 1 : 0,
      ...
      <div className="group relative h-full w-full overflow-hidden">
        {slides.map((src, i) => (
          <Image
            ...
            priority={priority && i === 0}
            sizes={sizes}
            className={`${objectFit === "contain" ? "object-contain" : "object-cover"} ease-out`}
            style={{
