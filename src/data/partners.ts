...
export const hiringPartnerLogos: PartnerLogo[] = [
  ...
  { name: "Culture Circle", src: asset("images/logos/culture-circle.png"), treatment: "color" },
  ...
  { name: "AWS", src: asset("images/logos/panel-mentors/aws.svg"), treatment: "mono" },
  { name: "Cars24", src: asset("images/logos/panel-mentors/cars.png"), treatment: "color" },
  { name: "Cipla", src: asset("images/logos/panel-mentors/cipla.svg"), treatment: "color" },
  { name: "Favcy", src: asset("images/logos/panel-mentors/favcy.png"), treatment: "color" },
  { name: "INDmoney", src: asset("images/logos/panel-mentors/indmoney.png"), treatment: "color" },
  { name: "Snitch", src: asset("images/logos/panel-mentors/snitch.webp"), treatment: "color" },
  { name: "SquadStack", src: asset("images/logos/panel-mentors/squadstack.png"), treatment: "color" },
  { name: "Tata", src: asset("images/logos/panel-mentors/tata.svg"), treatment: "mono" },
  { name: "Truefan", src: asset("images/logos/panel-mentors/truefan.png"), treatment: "color" },
];
