...
export const INDEXABLE_ROUTES: SitemapRoute[] = [
  ...
  {
    path: "/fellowship-gtm-revenue-ai",
    changeFrequency: "weekly",
    priority: 0.95,
    lastModified: "2026-07-06",
  },
  {
    path: "/fellowship-gtm-revenue-ai/curriculum",
    changeFrequency: "monthly",
    priority: 0.85,
    lastModified: "2026-07-06",
  },
  {
    path: "/fellowship-gtm-revenue-ai/placements",
    changeFrequency: "monthly",
    priority: 0.85,
    lastModified: "2026-07-06",
  },
  {
    path: "/fellowship-gtm-revenue-ai/admissions",
    changeFrequency: "monthly",
    priority: 0.85,
    lastModified: "2026-07-06",
  },
